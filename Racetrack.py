...
class Racetrack(Obj3D):
    def __init__(self, gameObj, trackName="test.track"):
        ...
        self.generateRacetrackFromFile_jesnk(trackName)

        # jesnk : it might cause prob
    ...
    def generateRacetrackFromFile_jesnk(self, fileName):
        ...
        for i in range(N):
            ...
            leftTrackPoints.append((point, angles))
            rightTrackPoints.append((point, angles))
        ...
        for i in range(int(N/2)):
            ...
            if i >= N-1 :
                ...
                continue
            # Left Track
            p0, angles = leftTrackPoints[2*i]
            p1, _ = leftTrackPoints[(2*i+1)]
    ...
    def genWallsFromPointToPoint(self, startPoint, endPoint, angles=None):
        print("genWallsFromPointToPoint : ",startPoint," ",endPoint)
